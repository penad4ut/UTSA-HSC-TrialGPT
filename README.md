...
This system adapts the TrialGPT reasoning approach to perform automated extraction of clinical trial eligibility evidence from EHR notes using **locally deployed large language models (LLMs)** for use inside protected health information (PHI) environments.
